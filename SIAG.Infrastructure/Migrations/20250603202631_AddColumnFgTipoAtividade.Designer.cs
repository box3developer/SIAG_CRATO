...
namespace SIAG.Infrastructure.Migrations
{
    ...
    [Migration("20250603202631_AddColumnFgTipoAtividade")]
    partial class AddColumnFgTipoAtividade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Cadastro.Models.Atividade", b =>
                {
                    b.Property<int>("IdAtividade")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("FgTipoAtividade")
                        .HasColumnType("int")
                        .HasColumnName("fg_tipoatividade");
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Cadastro.Models.AtividadePrioridade", b =>
                {
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Cadastro.Models.AtividadeRejeicao", b =>
                {
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Cadastro.Models.AtividadeRotina", b =>
                {
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Cadastro.Models.AtividadeTarefa", b =>
                {
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Core.Models.Chamada", b =>
                {
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Core.Models.ChamadaTarefa", b =>
                {
                    b.Property<DateTime?>("DtFim")
                        .HasColumnType("datetime2")
                        .HasColumnName("dt_fim");
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Core.Models.Historico", b =>
                {
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Core.Models.HistoricoPallet", b =>
                {
                    b.Property<int>("IdHistoricoPallet")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("id_historicopallet");
                    ...
                    b.Property<int?>("IdResponsabilidade")
                        .HasColumnType("int")
                        .HasColumnName("id_responsabilidade");

                    b.Property<string>("NmHistorico")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("nm_historico");

                    b.HasKey("IdHistoricoPallet");
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Cadastro.Models.AtividadeTarefa", b =>
                {
                    b.HasOne("SIAG.Domain.Chamada.Cadastro.Models.AtividadeRotina", "AtividadeRotina")
                        .WithMany()
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Core.Models.Chamada", b =>
                {
                    ...
                    b.HasOne("SIAG.Domain.Chamada.Cadastro.Models.Atividade", "Atividade")
                        .WithMany()
                        .HasForeignKey("IdAtividade");

                    b.HasOne("SIAG.Domain.Chamada.Cadastro.Models.Atividade", "Atividaderejeicao")
                        .WithMany()
                        .HasForeignKey("IdAtividaderejeicao");

                    b.HasOne("SIAG.Domain.Chamada.Core.Models.Chamada", "Chamadaorigem")
                        .WithMany()
                        .HasForeignKey("IdChamadaorigem");

                    b.HasOne("SIAG.Domain.Chamada.Core.Models.Chamada", "Chamadasuspensa")
                        .WithMany()
            ...
            modelBuilder.Entity("SIAG.Domain.Chamada.Core.Models.ChamadaTarefa", b =>
                {
                    b.HasOne("SIAG.Domain.Chamada.Core.Models.Chamada", "Chamada")
                        .WithMany()
                        .HasForeignKey("IdChamada")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SIAG.Domain.Chamada.Cadastro.Models.AtividadeTarefa", "Tarefa")
                        .WithMany()
