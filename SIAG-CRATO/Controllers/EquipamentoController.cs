...
namespace SIAG_CRATO.Controllers
{
    ...
    {
        [HttpGet]
        public async Task<ActionResult<IEnumerable<EquipamentoModel>>> GetListAsync()
        {
        ...
        [HttpGet("caracois")]
        public async Task<ActionResult<IEnumerable<EquipamentoModel>>> GetAllCaracois()
        {
        ...
        public async Task<ActionResult<IEnumerable<EquipamentoModel>>> GetByModeloAsync(int modeloId)
        {
