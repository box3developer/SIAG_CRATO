...
{
    public const string SELECT = "SELECT id_equipamento, nm_equipamento, id_equipamentomodelo, nm_identificador, id_operador, cd_leitura_pendente, cd_ultimaleitura, dt_ultimaleitura FROM equipamento WITH(NOLOCK)";
